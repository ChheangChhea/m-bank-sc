...
public class KeyUtil {
    ...
    private String accessTokenKeyPrivatePath;
    @Value("${access-token.public}")
    private String accessTokenKeyPublicPath;
    @Value("${refresh-token.private}")
    private String refreshTokenPrivateKeyPath;
    @Value("${refresh-token.public}")
    private String refreshTokenPublicKeyPath;

    private KeyPair accessTokenKeyPar;
    private KeyPair refreshTokenKeyPair;

  public KeyPair getAccessTokenKeyPar(){
      if(Objects.isNull(accessTokenKeyPar)){
          accessTokenKeyPar = getKeyPair(accessTokenKeyPublicPath,accessTokenKeyPrivatePath);
      }
      return  accessTokenKeyPar;
  }
...
//            }
    ...
    public RSAPublicKey getAccessTokenPublicKey() {
        return (RSAPublicKey) getAccessTokenKeyPar().getPublic();
    }

    public RSAPrivateKey getAccessTokenPrivateKey() {
        return (RSAPrivateKey) getAccessTokenKeyPar().getPrivate();
    }
